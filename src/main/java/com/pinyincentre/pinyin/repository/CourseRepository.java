...
public interface CourseRepository extends JpaRepository<Course, String> {
    ...
    @Query(value = """
            SELECT c.id, c.course_name, c.created_date, c.slot_quantity, c.description, c.price, c.hsk_category_id as hskCategoryId, hc.name as hskCategoryName
            FROM courses c
            LEFT JOIN hsk_categories hc ON c.hsk_category_id = hc.id
            WHERE c.is_delete = 0
